...
The script writes:
    backend/ml/results/outcome_report_<tag>.md
    backend/ml/results/outcome_report_<tag>.json
...
def build_splits_and_outcomes(
    ...
    feature_vocab = json.loads(Path("backend/training_data/feature_vocab.json").read_text())
