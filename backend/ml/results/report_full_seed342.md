...
|---|---:|---:|---:|
| Latent MSE | 1.9430 | 1.9698 | 1.9485 |
| Cosine sim | 0.9956 | 0.9957 | 0.9956 |
| Explained var | 0.1094 | 0.1029 | 0.0981 |
| Target emb std | 0.2832 | 0.2781 | 0.2823 |
| Ctx emb std | 0.3218 | 0.3272 | 0.3354 |
| z-sensitivity | 0.2814 | 0.2815 | 0.2814 |
| z-sens / std(s_y) | 0.9937 | 1.0122 | 0.9966 |
...
- **GOOD** — Positive explained variance: test EV = +0.098
...
- **GOOD** — No pathological train/val gap: val−train MSE = +0.0269
