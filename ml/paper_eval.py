...
Usage
-----
  python -m ml.paper_eval
  python -m ml.paper_eval --checkpoint ml/checkpoints/jepa_best.pt --out-dir ml/results
  python -m ml.paper_eval --skip-qdrant  # no Qdrant; latent tests only
"""
...
class PaperEvalConfig:
    ...
    feature_vocab_path: str = "training_data/feature_vocab.json"
    qdrant_path: str = "ml/qdrant_paper_eval"
